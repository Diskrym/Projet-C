...
{   
    ...
    if (meduse->Life==0)
    {
        ...
        if (meduse->CompteurSpriteDegat==5 || meduse->CompteurSpriteDegat==6 || meduse->CompteurSpriteDegat==7 || meduse->CompteurSpriteDegat==8 )
        {
            SDL_Texture *Spritemonstre=loadImage("src/graphics/Medusemort2.png");
            drawImage(Spritemonstre,meduse->posmonsx,meduse->posmonsy);
        }
        if (meduse->CompteurSpriteDegat==9 || meduse->CompteurSpriteDegat==10 || meduse->CompteurSpriteDegat==11 || meduse->CompteurSpriteDegat==12)
        {
            SDL_Texture *Spritemonstre=loadImage("src/graphics/Medusemort3.png");
            drawImage(Spritemonstre,meduse->posmonsx,meduse->posmonsy);
        }
        if (meduse->CompteurSpriteDegat==13 || meduse->CompteurSpriteDegat==14 || meduse->CompteurSpriteDegat==15 || meduse->CompteurSpriteDegat==16 )
        {
            SDL_Texture *Spritemonstre=loadImage("src/graphics/Medusemort4.png");
            drawImage(Spritemonstre,meduse->posmonsx,meduse->posmonsy);
        }
        if (meduse->CompteurSpriteDegat==7 || meduse->CompteurSpriteDegat==18 || meduse->CompteurSpriteDegat==19 || meduse->CompteurSpriteDegat==20 )
        {
            SDL_Texture *Spritemonstre=loadImage("src/graphics/Medusemort5.png");
            drawImage(Spritemonstre,meduse->posmonsx,meduse->posmonsy);
            if(meduse->NumSprit==20)
            {
